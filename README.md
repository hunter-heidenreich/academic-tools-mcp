...
| [bioRxiv/medRxiv](https://www.biorxiv.org/) | Preprint metadata, authors, abstracts, the journal version's name and date, BibTeX, PDF download | None |
...
.cache/
  ...
  biorxiv/pubs/            # Journal versions from bioRxiv's /pubs (JSON)
...
| biorxiv (pubs) | 7d | 1h | A journal link, once made, is stable; a preprint with none can gain one any day. |
