...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "when you know the name and want the identifier. search_wikipedia "
        "searches article text, not papers: use it to situate a concept, method "
        "or person, and read its `did_you_mean` before concluding a topic is "
        "absent.\n\n"
