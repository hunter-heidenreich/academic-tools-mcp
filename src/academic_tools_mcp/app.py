...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "search_openalex hit is free to chain (it warms the same cache); a "
        "search_crossref_by_title hit warms the reference tools, not "
        "get_paper_metadata. search_openalex is the broad topic search, "
        "search_arxiv the field-scoped preprint one, search_crossref_by_title "
        "for finding a DOI from a title.\n\n"
