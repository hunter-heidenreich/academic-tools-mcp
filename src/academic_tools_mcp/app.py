...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "arXiv paper's own HTML rendering, or a bioRxiv/medRxiv paper's JATS "
        "XML, into markdown in seconds, with no PDF needed; other papers need "
        "download_pdf first. convert_paper(mode="
        "'fast') is a seconds-long degraded fallback: plain text, no tables, "
        "equations, or headings. A real download drops cached markdown + "
        "sections; markdown from import_paper, arXiv's HTML or bioRxiv's JATS "
        "survives unless "
...
CONVERT_FORCE_REFRESH = Annotated[
    ...
    Field(
        description=(
            ...
            "(for arXiv and bioRxiv papers, their HTML or JATS is fetched again). "
